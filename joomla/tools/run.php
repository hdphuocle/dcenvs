...
if(file_exists('tags.json')){
    ...
    $tags = file_get_contents('https://registry.hub.docker.com/v1/repositories/joomla/tags');
...
foreach($tags as $tag){
    ...
    $myrd = '# Joomla '.$tag['name'].'

<a href="https://www.vsplate.com/?docker-compose=https://github.com/vsplate/dcenvs/joomla/'.$tag['name'].'"><img alt="VSPLATE GO" src="https://raw.githubusercontent.com/vsplate/images/master/vsgo_btn.png" width="200px"></a>
